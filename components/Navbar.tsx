...
const Navbar = () => {
  ...
  const sidebarClassNames = `fixed flex flex-col ${isSidebarCollapsed ? 'w-0 m:w-16' : 'w-72 m:w-64'} bg-white transition-all duration-300 overflow-hidden h-full shadow-md z-40`
